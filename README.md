...
- Sessions enable servers to store information about users so that user don't have to reauthenticate every time they make a request to a server.

1. What does bcrypt do to help us store passwords in a secure manner.

- When you use bcrypt, passwords are hashed (essentially transformed from the plain text)

1. What does bcrypt do to slow down attackers?

- bcrypt slows down attackers by implementing an algorithm to hash a password multiple times, thereby making it more difficult for attackers
